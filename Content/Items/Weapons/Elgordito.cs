...
using test.Content.Rarities;

namespace test.Content.Items.Weapons
{
	public class ElGordito : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.rare = ModContent.RarityType<TestRarity>(); // The item's rarity. This changes the color of the item's name.
			Item.value = Item.buyPrice(gold: 1); // The amount of money that the item is can be bought for.		

			Item.shoot = ModContent.ProjectileType<ElGorditoProjectile>(); // Which projectile this item will shoot. We set this to our corresponding projectile.
